...
public class Main{
    ...
    private static int simplelibraryExtendedSize = 539;
    /**
     * Set to "" for latest, otherwise exact version #
     */
    private static String requiredSimpleLibraryExtendedVersion = "1.0";
    private static String versionListURL = "https://www.dropbox.com/s/c4yj9a8ady6zmgw/versions.txt?dl=1";
    public static final String applicationName = "Amazing Machine";
...
//                    break;
            ...
            if(!new File(getLibraryRoot()+"\\Simplelibrary_extended "+requiredSimpleLibraryExtendedVersion+".jar").exists()){
